import azure.cosmos
import Param_ProjectName_Snake.sql.settings
...
class SQLObj:
    def __init__(self):
        self.client = azure.cosmos.CosmosClient(
            url=Param_ProjectName_Snake.sql.settings.connection_key, credential=Param_ProjectName_Snake.sql.settings.master_key
        )
