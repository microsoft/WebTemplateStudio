...
const messages = defineMessages({
    ...
    freeAccountQuestion: {
        ...
        id: "azureLoginModal.freeAccountQuestion"
    },
    freeTrialUpgradeAnswer: {
        defaultMessage: "After 12 months, any of these products you may be using will continue to run, and you’ll be billed at the standard pay-as-you-go rates.",
