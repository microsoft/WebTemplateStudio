...
describe("SelectOption", () => {
    ...
    props = {
      ...
      options:[
        ...
        },
        {
          ...
          defaultName: "List",
          internalName: "wts.Page.React.List",
          isValidTitle: true,
          licenses: [{}],
  ...
  it("on first moment should have 1 page blank", () => {
    ...
    expect(props.cardTypeCount["wts.Page.React.Blank"]).toBe(1);
  });

  it("add 1 page blank", () => {
    instance.addPage(0);
    expect(props.cardTypeCount["wts.Page.React.Blank"]).toBe(2);
  });

  it("add 1 page blank", () => {
    instance.addPage(0);
    expect(props.cardTypeCount["wts.Page.React.Blank"]).toBe(3);
  });
