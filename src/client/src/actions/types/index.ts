...
const SET_PATH_AND_NAME_VALIDATION =
  "WTS/wizardSelections/SET_PATH_AND_NAME_VALIDATION";
...
const REMOVE_AZURE_FUNCTIONS_APP = "WTS/azureFunctions/REMOVE_AZURE_FUNCTIONS_APP";
